...
namespace soporte.Equipos
{
    public partial class video : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable DTvideo = temp.DefaultView.ToTable();
            string ide = Server.HtmlEncode(Request.QueryString["id"]);
            idequipo.Value = ide;
            DBConnect conexion = new DBConnect();
            idmram.Value = ide + Convert.ToString(DTvideo.Rows.Count);
            int instalados = DTvideo.Rows.Count;
            CargarGrid();
            Label1.Text = "Número de Tarjetas: " + Convert.ToString(instalados);
            HiddenField1.Value = Convert.ToString(DTvideo.Rows.Count);
            if (!IsPostBack)
            {
                htipo.Items.Clear();
            }
            DataTable lsoporte = conexion.Shtdispositivo("8");
        ...
        private void CargarGrid()
        {
            ...
            temporal.DefaultView.RowFilter = string.Format("htipo = 8");
            DataTable Datav = temporal.DefaultView.ToTable();
        ...
        protected void Guardar(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                Response.Redirect("video.aspx?id=" + System.Web.HttpUtility.UrlEncode(idequipo.Value));
            }
        }
        ...
        protected void GridView1_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            ...
            Response.Redirect("video.aspx?idequipo=" + System.Web.HttpUtility.UrlEncode(idequipo.Value));
        }
    }
}
