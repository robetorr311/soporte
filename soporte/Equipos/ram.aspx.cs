...
namespace soporte.Equipos
{
    public partial class ram : System.Web.UI.Page
    {
        ...
        private void CargarGrid()
        {
            ...
            temporal.DefaultView.RowFilter = string.Format("htipo = 9");
            DataTable Dataram = temporal.DefaultView.ToTable();
            if (Dataram.Rows.Count > 0)
            {
                GridView1.DataSource = Dataram;
                GridView1.DataBind();
        ...
        protected void Guardar(object sender, EventArgs e)
        {
            ...
            string cap = capacidadram.SelectedItem.Text;
            string hcap = capacidadram.SelectedValue;
            if ((serial == "") | (marca == "") | (numero == "") | (heq == "") | (key == "") | (htdisp == "0") | (hcap == "0"))
            {
                ...
                if (hcap == "0")
                {
                    capacidadram.CssClass = "campoerror";
                }
            ...
            else
            {
                ...
                Response.Redirect("ram.aspx?id=" + System.Web.HttpUtility.UrlEncode(idequipo.Value));
            }
        }
