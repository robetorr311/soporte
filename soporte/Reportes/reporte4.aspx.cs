...
namespace soporte.Reportes
{
    public partial class reporte4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string soportemay = soporte.ToUpper();
            DBConnect conexion = new DBConnect();
            DataTable DTrptpendiente = conexion.RPTpendiente(soporte, fechainicio,fechafinal);
            DataTable DTrptenrevision = conexion.RPTenrevision(soporte, fechainicio,fechafinal);
            DataTable DTrptculminado = conexion.RPTculminado(soporte,fechainicio,fechafinal);
            ...
            //Titulo de reporte
            myFirstPage.addText("ACTIVIDADES REALIZADAS POR " + soportemay, 150, 680, myDoc.getFontReference(sharpPDF.Enumerators.predefinedFont.csHelvetica), 12);
