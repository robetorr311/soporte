...
{
    public partial class frmreporte4 : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                if ((menu == "1") || (Session["Session"] != null))
                {
                    ...
                    DataTable lsoporte = conector.SAllDepartamentos();
                    ListItem inicio = new ListItem();
                    inicio.Text = "Seleccione";
                    inicio.Value = "0";
                    departamento.Items.Add(inicio);
        ...
        protected void PDF(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    Response.Redirect("reporte6.aspx?fechainicio=" +
                                       System.Web.HttpUtility.UrlEncode(fechai) +
                                       "&fechafinal=" + System.Web.HttpUtility.UrlEncode(fechaf) +
                                       "&departamento=" + System.Web.HttpUtility.UrlEncode(departamento.SelectedItem.Text) +
