<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmReporte2.aspx.cs" Inherits="soporte.Reportes.frmReporte2" %>
...
<body  class="bodyformulario" onload="cargar();">
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td  class="tdformulario">Seleccione el T&eacute;cnico: </td>
        <td  class="tdformulario" width="218">
            <asp:DropDownList ID="soporte" CssClass="select" runat="server">
            </asp:DropDownList>
        </td>
