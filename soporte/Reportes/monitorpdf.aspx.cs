...
{
    public partial class monitorpdf : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            DataTable listado = conector.SVMonitores(idmonitor);
            ...
            myFirstPage.addText("1.8 Tipo de Monitor", 45, 562, myDoc.getFontReference(sharpPDF.Enumerators.predefinedFont.csHelvetica), 10, new sharpPDF.pdfColor(255, 255, 255));
