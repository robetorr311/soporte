<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmreporte4.aspx.cs" Inherits="soporte.Reportes.frmreporte4" %>
...
<body  class="bodyformulario" onload="cargar();">
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    ...
    <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td class="titulo_form"><asp:Image ID="Image1" ImageUrl="../Imagenes/frmreporte4.gif" runat="server" /></td>
    </tr>
  </table>
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td  class="tdformulario">Seleccione el Departamento: </td>
        ...
        <td  class="tdformulario" width="2">
            <asp:RequiredFieldValidator id="RFVsoporte"
