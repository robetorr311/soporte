<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="procesador.aspx.cs" Inherits="soporte.Equipos.procesador" %>
...
<body class="bodyformulario" onload="cargar();" onunload="retornaCPU();">
...
<table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td  class="tdformulario" width="29">Velocidad:</td>
    <td  class="tdformulario" width="143">
    <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
    </td>
    <td  class="tdformulario" width="11">&nbsp;</td>
    <td  class="tdformulario" width="20"><img src="../Imagenes/helpbn.gif" alt=""  width="20" height="20"  onmouseover="muestraAyuda(event, 'Velocidad');"/></td>
  </tr>
</table>
<table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
