...
namespace soporte.Equipos
{
    public partial class procesador : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            string idram = ide + Convert.ToString(conexion.IDram(ide, "10"));
            idmdisco.Value = idram;
            CargarGrid(idequipo.Value, "10");
            Label1.Text = "Número de Procesadores: " + Convert.ToString(GridView1.Rows.Count);
            HiddenField1.Value = Convert.ToString(conexion.IDram(ide, "10"));
        ...
        {
            DBConnect conexion = new DBConnect();
            DataTable datos = conexion.Stemporal(hequipo, "10");
        ...
        protected void Guardar(object sender, EventArgs e)
        {
            ...
            conector.ITemporal(key, serial, marca, numero, htdisp, cap, "10", heq);
            CargarGrid(idequipo.Value, "10");
