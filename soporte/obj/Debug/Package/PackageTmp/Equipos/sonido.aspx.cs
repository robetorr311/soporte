    ...
    public partial class sonido : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                Int64 i = conexion.IDram(ide, "12");
                if (i > 0)
                {
                    DataTable datos = conexion.Stemporal(ide, "12");
                ...
                HiddenField1.Value = Convert.ToString(conexion.IDram(ide, "12"));
            }
        }
        protected void Guardar(object sender, EventArgs e)
        {
            ...
            string htdisp = "0";
            string key = "0";
            conexion.ITemporal(key, serial, marca, numero, htdisp, "null", "12", heq);
            HiddenField1.Value = Convert.ToString(conexion.IDram(heq, "12"));
