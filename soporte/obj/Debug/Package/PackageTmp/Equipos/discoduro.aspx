<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="discoduro.aspx.cs" Inherits="soporte.Equipos.discoduro" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="../JS/discoduro.js"></script>
    <base target="_self" />    
</head>
<body class="bodyformulario" onload="cargar()" onunload="retornaDiscoduro();">
...
<table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td  class="tdformulario" width="143">
        <asp:RadioButton ID="RadioButton1" runat="server" GroupName="tipo" Text="IDE" /> 
        <asp:RadioButton ID="RadioButton2" runat="server" GroupName="tipo" Text="SATA" /> 
        <asp:RadioButton ID="RadioButton3" runat="server" GroupName="tipo" Text="Externo" /> 
    </td>
    <td  class="tdformulario" width="11">&nbsp;</td>
