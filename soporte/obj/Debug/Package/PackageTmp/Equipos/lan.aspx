<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="lan.aspx.cs" Inherits="soporte.Equipos.lan" %>
...
<body class="bodyformulario" onload="cargar();" onunload="retornaLAN();">
...
<table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td  class="tdformulario" width="29">Mac Address:</td>
    <td  class="tdformulario" width="143">
    <asp:TextBox ID="TextBox4" runat="server"></asp:TextBox>
    </td>
    <td  class="tdformulario" width="11">&nbsp;</td>
    <td  class="tdformulario" width="20"><img src="../Imagenes/helpbn.gif" alt=""  width="20" height="20"  onmouseover="muestraAyuda(event, 'Mac Address');"/></td>
  </tr>
</table>
<table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
