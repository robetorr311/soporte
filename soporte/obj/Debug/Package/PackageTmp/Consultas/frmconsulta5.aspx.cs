...
{
    public partial class frmconsulta5 : System.Web.UI.Page
    {
        ...
        private void CargarGrid()
        {
            ...
            DataTable datos = conexion.SAllmonitores();
        ...
        {
            Response.Redirect("../Reportes/monitorpdf.aspx?idmonitor=" + TextBox1.Value);
        }
