...
{
    public partial class frmconsulta4 : System.Web.UI.Page
    {
        ...
        private void CargarGrid()
        {
            ...
            DataTable datos = conexion.SAllimpresoras();
        ...
        {
            Response.Redirect("../Reportes/impresorapdf.aspx?idimpresora=" + TextBox1.Value);
        }
