...
<div>
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <asp:Image 
      ID="Image1" 
      ImageUrl="../Imagenes/titulosol.gif" runat="server" /></td>
    </tr>
  </table>
  <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  class="tdformulario" width="189">
          <asp:DropDownList ID="departamento" CssClass="select" AutoPostBack="true" OnSelectedIndexChanged="tele" runat="server">
          </asp:DropDownList>
      </td>
      ...
      <td  class="tdformulario" width="19">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Departamento');"/>
      </td>
      ...
      <td  class="tdformulario" width="20">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Telefono');"/>
      </td>
    </tr>
  </table>
  <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  class="tdformulario" width="17">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Solicitante');"/>
      </td>
      ...
      <td  class="tdformulario" width="24">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Fecha');"/>
      </td>
    </tr>
  </table>
    <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  class="tdformulario">
          <asp:DropDownList ID="htipo" CssClass="select" OnTextChanged="controles" AutoPostBack="true" runat="server">
          </asp:DropDownList>   
      </td>
      <td  class="tdformulario" width="5">
      </td>
      <td  class="tdformulario" width="17">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Tipo');"/>
      </td>
    </tr>
  </table> 
   <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  class="tdformulario">
           <asp:DropDownList ID="nequipo" CssClass="select" AutoPostBack="true" runat="server">
          </asp:DropDownList>
      ...
      <td  class="tdformulario" width="17">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Nombre del equipo');"/>
      </td>
    </tr>
  </table>          
  <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  class="tdformulario" width="19">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Marca');"/>
      </td>
    </tr>
  </table>            
  <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
  ...
  <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  class="tdformulario" width="20">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Software');"/>
      </td>
    </tr>
    <tr>
  ...
  <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td  class="tdformulario" width="69">
        <img src="../Imagenes/helpbn.gif" alt="Ayuda" onmouseover="muestraAyuda(event, 'Solicitud: Hardware');"/>
      </td>
    </tr>
    <tr>
  ...
  <table class="tableformulario" width="500" border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td  class="tdbotones" align="center">
          <span onmouseover="this.style.cursor='pointer';muestraAyuda(event, 'Solicitud: Guardar');">
