<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="soporte._Default" %>
...
<table class="tablebienvenida" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td class="tdbienvenida" width="498"><img src="Imagenes/bienvenida.gif" alt="" width="500" height="20" /></td>
  </tr>
</table>
<table class="tablebienvenida" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td class="tdformulario" width="129">Ingrese el Loggin: </td>
    <td class="tdformulario" width="331">
...
<table class="tdformulario" width="500" border="1" cellspacing="0" cellpadding="0">
  <tr>
    <td class="tdformulario" width="129">Ingrese el Password: </td>
    <td class="tdformulario" width="334">
