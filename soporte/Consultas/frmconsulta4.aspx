<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmconsulta4.aspx.cs" Inherits="soporte.Consultas.frmconsulta4" %>
...
<body class="bodyformulario" onload="cargar();">
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <asp:Image 
      ID="Image1" 
      ImageUrl="../Imagenes/tituloconsulta4.gif" runat="server" /></td>
    </tr>
  </table>
