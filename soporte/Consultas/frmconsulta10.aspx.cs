...
{
    public partial class frmconsulta10 : System.Web.UI.Page
    {
        ...
        private void CargarGrid()
        {
            ...
            DataTable datos = conexion.SAllteclados();
        ...
        {
            Response.Redirect("../Reportes/tecladopdf.aspx?idmonitor=" + TextBox1.Value);
        }
