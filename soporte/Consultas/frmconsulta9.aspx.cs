...
{
    public partial class frmconsulta9 : System.Web.UI.Page
    {
        ...
        private void CargarGrid()
        {
            ...
            DataTable datos = conexion.SAllmouses();
        ...
        {
            Response.Redirect("../Reportes/mousepdf.aspx?idmonitor=" + TextBox1.Value);
        }
