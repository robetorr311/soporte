<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmconsulta8.aspx.cs" Inherits="soporte.Consultas.frmconsulta8" %>
...
<body class="bodyformulario" onload="cargar();">
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <asp:Image 
      ID="Image1" 
      ImageUrl="../Imagenes/tituloconsulta8.gif" runat="server" /></td>
    </tr>
  </table>
