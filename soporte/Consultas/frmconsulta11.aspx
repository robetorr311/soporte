<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmconsulta11.aspx.cs" Inherits="soporte.Consultas.frmconsulta11" %>
...
<body class="bodyformulario" onload="cargar();">
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <asp:Image 
      ID="Image1" 
      ImageUrl="../Imagenes/tituloconsulta11.gif" runat="server" /></td>
    </tr>
  </table>
       <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0" onmouseover="self()">
            <tr>
