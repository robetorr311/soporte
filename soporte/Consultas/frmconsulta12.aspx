<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmconsulta12.aspx.cs" Inherits="soporte.Consultas.frmconsulta12" %>
...
<body class="bodyformulario" onload="cargar();">
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <asp:Image 
      ID="Image1" 
      ImageUrl="../Imagenes/tituloconsulta12.gif" runat="server" /></td>
    </tr>
  </table>
