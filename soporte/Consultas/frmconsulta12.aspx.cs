...
{
    public partial class frmconsulta12 : System.Web.UI.Page
    {
        ...
        private void CargarGrid()
        {
            ...
            DataTable datos = conexion.SAllswitches();
        ...
        {
            Response.Redirect("../Reportes/switchepdf.aspx?idmonitor=" + TextBox1.Value);
        }
