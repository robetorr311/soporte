<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmPerifericos.aspx.cs" Inherits="soporte.Consultas.frmPerifericos" %>
...
<body onload="cargar()" class="bodyformulario">
                ...
                <asp:GridView ID="GridView1" 
					...
					<asp:TemplateField HeaderText="Edit" ShowHeader="False"> 
						<ItemTemplate>
							...
							<span onmouseover="muestraAyuda(event, 'Consultas: Desincorporar');"><asp:ImageButton ID="ImageButton7" Enabled="false"  CommandName="Desincorpora" Text="Desincorporar" CausesValidation="false" ButtonType="Image" ImageUrl="../Imagenes/desincorporar.gif" runat="server" /></span>
						</ItemTemplate> 
					<EditItemTemplate>    
                    ...
                    <asp:TemplateField HeaderText="Modelo" Visible="true">					
						<ItemTemplate>
                            <asp:Label ID="Lblmodelo" runat="server" Text='<%# Eval("Modelo") %>'></asp:Label>
                        </ItemTemplate>
                        <EditItemTemplate>
                            <asp:TextBox ID="TBXmodelo" CssClass="textboxgrid" runat="server" Text='<%# Eval("Modelo") %>'></asp:TextBox>
                        </EditItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Tipo" Visible="true">					
                        ...
                        <EditItemTemplate>
                           <asp:Label ID="Lbltipo" runat="server" Text='<%# Eval("Tipo") %>'></asp:Label>
                           <asp:DropDownList ID="DGtipo" CssClass="select" runat="server">
                            </asp:DropDownList>
                        </EditItemTemplate>
                    </asp:TemplateField>
                    </Columns>
  ...
  <table class="tableformulario" width="800" border="0" cellspacing="0" cellpadding="0">
    ...
    <input type="hidden" id="htperiferico" runat="server" />
    </form>
