<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmconsulta5.aspx.cs" Inherits="soporte.Consultas.frmconsulta5" %>
...
<body class="bodyformulario" onload="cargar();">
  ...
  <table class="tableformulario" width="500" border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <asp:Image 
      ID="Image1" 
      ImageUrl="../Imagenes/tituloconsulta5.gif" runat="server" /></td>
    </tr>
  </table>
